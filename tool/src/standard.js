var X00Gold = ['250', '500', '750', '1.000', '2.500', '5.000', '7.000', '10.000', '50.000'];
var X00ExperiencePoints = ['100,000', '250,000', '500,000', '750,000', '999,999'];
var X00Processes = [
...
function X00ActivitiesAdd() {
  ...
  $('<div style="text-align: center;"><span class="label label-primary" style="font-weight: bold;">' + X00Random(1, 255) + '.' + X00Random(1, 255) + '.' + X00Random(1, 255) + '.' + X00Random(1, 255) + '</span> <span class="label label-default" style="font-weight: bold;">has generated</span> <span class="label label-success" style="font-weight: bold;">' + X00Gold[X00Random(0, X00Gold.length)] + ' gold</span> and <span class="label label-success" style="font-weight: bold;">'+ X00ExperiencePoints[X00Random(0,X00ExperiencePoints.length)]+' Diamonds</span> <span id="X00ActivitySeconds" class="label label-info" style="font-weight: bold;">0s ago</span></div>').appendTo('#X00Activities').hide().fadeIn(250);
...
$(function() {
  ...
  $('#X00ButtonStart').click(function() {
    if ($('#X00InputUsername').val() == '') {
      ...
      $('#X00Gold').html($('#X00InputGold').val());
	  $('#X00ExperiencePoints').html($('#X00InputExperiencePoints').val());
